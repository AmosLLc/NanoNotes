...
<img src="1 JVM运行时数据区域.assets/image-20200328165107835.png" alt="image-20200328165107835" style="zoom:77%;" />

以下是 **Java8** 版本的**运行时数据区**，方法区由**元空间**实现。元空间存在于**直接内存**中。

<img src="1 JVM运行时数据区域.assets/image-20200328165327534.png" alt="image-20200328165327534" style="zoom:77%;" />
...
<img src="1 JVM运行时数据区域.assets/image-20200328170859988.png" alt="image-20200328170859988" style="zoom:47%;" />
...
<img src="1 JVM运行时数据区域.assets/20170329213804490.png" alt="img" style="zoom:40%;" />
