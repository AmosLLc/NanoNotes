...
<img src="assets/zookeeper-distributed-coordination.png" alt="zookeeper-distributed-coordination" style="zoom:80%;" />
...
<img src="assets/zookeeper-distributed-lock-demo.png" alt="zookeeper-distributed-lock-demo" style="zoom:80%;" />

##### 3. 元数据/配置信息管理

zookeeper 可以用作很多系统的配置信息的管理，比如 kafka、storm 等等很多分布式系统都会选用 zookeeper 来做一些元数据、配置信息的管理，包括 dubbo 注册中心不也支持 zookeeper 么？

<img src="assets/zookeeper-meta-data-manage.png" alt="zookeeper-meta-data-manage" style="zoom:80%;" />
