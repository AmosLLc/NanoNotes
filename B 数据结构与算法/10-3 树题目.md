...
<img src="assets/image-20200422130604081.png" alt="image-20200422130604081" style="zoom:80%;" />![image-20200422130619433](assets/image-20200422130619433.png)
...
可以直接新建一颗树，直接用中序遍历的方式进行构造。但是这样空间复杂度比较高。
