...
**==记住下面这个就行！！！==**上述修改指针较为复杂，这里用一种**两个指针**的头插法，也就是引入 **dummy 结点**，然后把**第一个结点**先弄好，之后每次将新的结点插入到 dummy 结点的**后面一个**。
...
<img src="assets/image-20200531172423551.png" alt="image-20200531172423551" style="zoom:50%;" />
